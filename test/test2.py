...
n_total = 1201
n_data  = 121
x_total = np.linspace(-6, 6, n_total).reshape(-1, 1)
y_total  = x_total * np.sin(x_total**2)
indices_train = np.array(np.arange(0, 1201, 10), dtype='int') # np.sort(random.sample(range(0, n_total), n_data))
...
networks = [(23, "tanh"), (25, "sigmoid"), (27, "sigmoid"), (23, "softplus"),
           (24, "sigmoid"), (29, "tanh"), (26, "tanh"), (23, "sigmoid"),
           (24, "tanh"), (25, "tanh"), (28, "sigmoid"), (27, "tanh"),
           (26, "softplus"), (26, "tanh"), (26, "tanh")]
...
model.ensemble()
model.save_data("../results/test2/", networks)
model.plot_aggregate("../results/test2/")